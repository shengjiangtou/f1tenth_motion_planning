...
class FrenetPlaner:
    ...
    def calc_frenet_path (self, speed, c_d, c_d_d, c_d_dd, s0):
        path = 0

        return path

    def calc_global_path(self, speed, c_d, c_d_d, c_d_dd, s0):
        path = 0

        return path

    def calc_check_path(self, speed, c_d, c_d_d, c_d_dd, s0):
        path = 0
    ...
    def path_planner(self, vehicle_state, waypoints, timestep):
        ...
        fplist = self.calc_frenet_paths(vehicle_state[3], self.c_d, self.c_d_d, self.c_d_dd, s0)
